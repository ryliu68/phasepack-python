...
import struct
from benchmark_transmission_matrix import benchmarkTransmissionMatrix
...
# 2. Run benchmark
benchmarkTransmissionMatrix(
    imageSize, datasetSelection, residualConstant, algorithms)

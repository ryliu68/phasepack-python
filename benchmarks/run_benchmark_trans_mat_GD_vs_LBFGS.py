...
# 'label' for each algorithm, which is used to produce the legend of the
# plot.
twf_sd = struct('algorithm', 'twf', 'searchMethod',
                'steepestDescent', 'label', 'TWF-SD')
# runBenchmarkTransMatGDvsLBFGS.m:56
twf_lbfgs = struct('algorithm', 'twf', 'searchMethod',
                   'LBFGS', 'label', 'TWF-LBFGS')

...
def runImageReconstructionDemo():
    ...
    # Convert random variables into binary (+1/-1) variables
    ...
    # Use the measurement operator 'A', defined below, to obtain phaseless measurements.
    b = abs(A(x))
    ...
    # Use the truncated Wirtinger flow method to solve the retrieval problem.  Try changing this to 'Fienup'.
    opts.algorithm = 'PhaseMax'
    # Use a spectral method with optimized data pre-processing to generate an initial starting point for the solver
    ...
    # measurements using the random binary masks defined above.
        ...
        def At(measurements):
            ...
            measurements = reshape(
                measurements, [num_fourier_masks, numrows, numcols])
